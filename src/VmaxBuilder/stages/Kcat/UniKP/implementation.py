...
class UniKPImplementation(RealImplementation[UniKPConfig]):
    ...
    def generate_outputs(self, scaffold: Scaffold) -> dict[str, dict[str, Any]]:
        ...
        smiles_df = cast(pd.DataFrame, scaffold.get_scaffold_value("SMILES_df"))
        transcript_df = cast(pd.DataFrame, scaffold.get_scaffold_value("transcript_df"))
